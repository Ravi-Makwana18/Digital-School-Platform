...
// If you want to enable this, uncomment it and make sure the disabled version below is commented out.
...
//         }
//     } catch (error) {
//         // FIX: Extract serializable error message
...
export const addStuff = (fields, address) => async (dispatch) => {
    ...
    try {
        ...
        const errorMessage = error.response?.data?.message || error.message || "Failed to add data.";
        dispatch(authError(errorMessage));
    }
};